...
const AddressModal = ({ addressModal, setAddressModal, mode, updateAddress, setRefresh, refresh }: AddressModalProps) => {
    ...
    return (
        <Fragment>
            <Modal title={mode ? "Cập nhật" : "Tạo địa chỉ"} open={addressModal} onOk={handleSubmit(onSubmit)} onCancel={() => setAddressModal(false)} centered confirmLoading={mode ? address.update.loading : address.create.loading}>
